...
/**
 *<p> <tt>InvalidPriorityException</tt> is an {@link Exception} that is thrown by {@link priorityqueues.PriorityQueue}
 * when the user supplies a non-positive integer priority.</p>
 *
