/**<p> <tt>AVLGTree</tt> is a parameterized version of AVL (<em>Adelson-Velsky-Landis</em>) trees.
 * Those trees allow efficient lookup, insertion and deletion in <em>O(logn)</em> time, by virtue
