...
public class ArrayMinHeapTest {
	...
	public void testSimpleAdd(){
		...
		try {
			assertEquals(stringMinHeap.deleteMin(), "George");
		}catch(EmptyHeapException e){
	...
	public void testSimpleAddUnbalanced(){
		...
		try{
			...
			assertEquals(intMinHeap.deleteMin(), new Integer(-1));
			assertEquals(intMinHeap.deleteMin(), new Integer(0));
			assertEquals(intMinHeap.deleteMin(), new Integer(3));
			assertEquals(intMinHeap.deleteMin(), new Integer(5));
			assertEquals(intMinHeap.deleteMin(), new Integer(8));
			assertEquals(intMinHeap.deleteMin(), new Integer(10));
