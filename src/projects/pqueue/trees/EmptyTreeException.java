 ...
 *
 * <p>Simply returning <tt>null</tt>  from search methods is ambiguous on the part of the caller, because the caller can then not tell whether
 * the tree is empty or not by simply checking for <tt>null</tt>-ity of the object reference. While, strictly
