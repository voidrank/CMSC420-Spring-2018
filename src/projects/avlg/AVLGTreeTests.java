...
public class AVLGTreeTests {
    ...
    public void easyTest(){
        try {
            ...
            assertEquals("The tree should have a height of -1!", -1 , intAVL1Tree.getHeight());
            intAVL1Tree.insert(8);
            assertFalse("The tree should be empty!", intAVL1Tree.isEmpty());
            assertEquals("The tree should have a height of 0!", 0, intAVL1Tree.getHeight());
    ...
    public void testEmptyAndStubTree(){
        try {
            ...
            assertTrue("Empty tree should have a height of -1.",
                    intAVL1Tree.getHeight() == -1 && stringAVL1Tree.getHeight() == -1);
            ...
            assertEquals("Tree should now have a height of -1 once more.", -1, intAVL1Tree.getHeight());
        }catch(EmptyTreeException exc){
            fail("Caught an EmptyTreeException with message: " + exc.getMessage() + ".");
        }
    }
    ...
    public void testBalancedInsertions(){
        try {
             ...
             */
            assertEquals("Tree not re-balanced properly.", 1, intAVL1Tree.getHeight());
            ...
            assertEquals("Incorrect tree height.", 1, stringAVL1Tree.getHeight());
            assertEquals("Incorrect key detected at root: Are you performing " +
            ...
            assertEquals("Tree not re-balanced properly.", 1, stringAVL1Tree.getHeight());
            ...
            assertEquals("Incorrect tree height after another insertion.", 2, intAVL1Tree.getHeight());
            ...
            assertEquals("Incorrect tree height after another insertion: " +
                    "are you balancing properly?", 2, intAVL1Tree.getHeight());
            ...
            assertEquals("Incorrect tree height after another insertion.", 2, stringAVL1Tree.getHeight());
            ...
            assertEquals("Incorrect tree height after another insertion: " +
                    "are you balancing properly?", 2, stringAVL1Tree.getHeight());
    ...
    public void testBalancedDeletions(){
        ...
        assertEquals("After this particular deletion, the tree's height should remain " +
                "the same.", 1, intAVL1Tree.getHeight());
        ...
        assertEquals("Incorrect tree height detected after deletions.", 0, intAVL1Tree.getHeight());
        ...
        assertEquals("Incorrect tree height. Are you " +
                "re-balancing correctly after deletions?", 1, intAVL1Tree.getHeight());
        ...
        assertEquals("After a deletion of an inner node, the height of the tree was not " +
                "properly updated.", 2, intAVL1Tree.getHeight());
